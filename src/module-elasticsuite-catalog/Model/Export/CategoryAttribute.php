    ...
    public function export()
    {
        ...
        foreach ($attributeCollection as $attribute) {
            ...
            foreach ($this->_getHeaderColumns() as $columnName) {
                $exportedColumnName = $attribute->getData($columnName);
                if ($columnName === 'attribute_label') {
                    $exportedColumnName = $attribute->getData('frontend_label');
                }
                $row[$columnName] = $exportedColumnName;
            }
            $writer->writeRow($row);
        }
