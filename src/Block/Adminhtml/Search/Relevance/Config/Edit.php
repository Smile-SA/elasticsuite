...
namespace Smile\ElasticSuiteCore\Block\Adminhtml\Search\Relevance\Config;
...
{
    const DEFAULT_SECTION_BLOCK = 'Smile\ElasticSuiteCore\Block\Adminhtml\Search\Relevance\Config\Form';
