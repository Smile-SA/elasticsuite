...
**>=2.4.8 && < 2.4.9** |ElasticSuite **2.11.x >= 2.11.13** : ```composer require smile/elasticsuite ~2.11.13``` | 7.x & 8.x | 1.x & 2.x **& 3.x** | **Yes**
**>=2.4.9** |ElasticSuite **2.12.x** : ```composer require smile/elasticsuite ~2.12.0``` | 7.x & 8.x | 1.x & 2.x **& 3.x** | **Yes**
